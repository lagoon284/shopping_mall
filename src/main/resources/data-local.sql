...
-- 게시판 데이터 삽입.
INSERT INTO BOARDINFO (TITLE, CONTENT, WRITER, WRITERID, REGDATE, VIEWCNT, LIKECNT, COMMENTCNT)
SELECT *
FROM (SELECT '제목' AS TITLE, '내용입니다.' AS CONTENT, '글쓴이' AS WRITER, 'test1' AS WRITERID, FORMATDATETIME(CURRENT_TIMESTAMP, 'yyyy-MM-dd HH:mm:ss') AS REGDATE, 0 AS VIEWCNT, 0 AS LIKECNT, 0 AS COMMENTCNT UNION ALL
      SELECT '제목1', '내용입니다1.', '글쓴이1', 'test2', FORMATDATETIME(CURRENT_TIMESTAMP, 'yyyy-MM-dd HH:mm:ss'), 0, 0, 0 UNION ALL
      SELECT '제목2', '내용입니다2.', '글쓴이2', 'test3', FORMATDATETIME(CURRENT_TIMESTAMP, 'yyyy-MM-dd HH:mm:ss'), 0, 0, 0 UNION ALL
      SELECT '제목3', '내용입니다3.', '글쓴이3', 'test4', FORMATDATETIME(CURRENT_TIMESTAMP, 'yyyy-MM-dd HH:mm:ss'), 0, 0, 0 UNION ALL
      SELECT '제목4', '내용입니다4.', '글쓴이4', 'test5', FORMATDATETIME(CURRENT_TIMESTAMP, 'yyyy-MM-dd HH:mm:ss'), 0, 0, 0) AS TEMP

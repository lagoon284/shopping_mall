...
export default function ProductReg() {
    ...
    return (
        <form onSubmit={(event) => onSubmitHandler(event)}>
            ...
            />
            <br/>
            {formData.providerMsg && <small style={{color: formData.isProvider ? "green" : "red"}}>{formData.providerMsg}</small>}<br/>
            <p/>

            <label htmlFor={'info'}>상품 정보 </label><br/>
            ...
            />
            <br/>
            {formData.infoMsg && <small style={{color: formData.isInfo ? "green" : "red"}}>{formData.infoMsg}</small>}<br/>
            <p/>
            ...
            <button type={'submit'} disabled= {!(formData.isProdName && formData.isPrice && formData.isProvider && formData.isInfo)}>등록하기</button>
        </form>
    )
}